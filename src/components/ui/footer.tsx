    ...
    <footer className="mt-16 border-t border-zinc-200 bg-zinc-50">
      <div className="mx-auto max-w-6xl px-4 py-10">
        ...
        <div className="lg:flex lg:items-start lg:justify-between lg:gap-12">
          ...
          <div>
            <div className="text-2xl font-semibold leading-none tracking-wide">JOHN LEWIS</div>
            <div className="mt-1 text-xs font-semibold ml-5 tracking-[0.3em] uppercase text-zinc-700">& Partners</div>
          </div>
          <div className="flex items-center justify-between gap-6 border-b border-zinc-300 pb-0">
            <span className="text-sm text-zinc-600">Get latest offers to your inbox</span>
            <button className="inline-flex h-8 w-8 items-center justify-center rounded-md bg-black text-white">›</button>
          </div>
          <div className="flex items-center gap-3">
            <button className="h-8 w-8 rounded-full border border-zinc-300 bg-white text-black flex items-center justify-center"><IconFacebook/></button>
            <button className="h-8 w-8 rounded-full border border-zinc-300 bg-white text-black flex items-center justify-center"><IconInstagram/></button>
            <button className="h-8 w-8 rounded-full border border-zinc-300 bg-white text-black flex items-center justify-center"><IconTwitter/></button>
            <button className="h-8 w-8 rounded-full border border-zinc-300 bg-white text-black flex items-center justify-center"><IconYoutube/></button>
          </div>
          </div>
          ...
          <div>
            <div className="mb-3 font-semibold">Information</div>
            <ul className="space-y-2 text-sm text-zinc-600">
        ...
        {/* Bottom bar */}
        <div className="mt-8 border-t border-dashed border-zinc-300 pt-6 text-sm text-zinc-600">
            ...
            <div className="ml-auto flex items-center gap-4">
              <button className="inline-flex items-center gap-2">
                <span aria-hidden>
                  ...
                  <svg width="16" height="12" viewBox="0 0 19 10" xmlns="http://www.w3.org/2000/svg">
